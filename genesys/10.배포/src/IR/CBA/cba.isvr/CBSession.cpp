...
NPVOID CCBSession::ThreadRun(NPVOID pArg)
{
    ...
    while(IsOn())
    {
        ...
        // 요청건 처리..
        LOG_WRITE(ILOG_INFO, "%s >>> %s|Data=(%d)%s", GetName(), PROC_NAME, nTotalLen, szTotalPacket);
        HandlePacket(qItem);
...
/****************************************************************************
 ...
 DATE        : 2014.06.26
****************************************************************************/
bool CCBSession::HandlePacket(QueueItem stQItem)
{
    char            szCommand[41];
...
/****************************************************************************
 ...
 DATE        : 2014.06.26
****************************************************************************/
bool CCBSession::HandleHeartBeat(QueueItem stQItem)
{
    ...
    LOG_WRITE(ILOG_INFO, "%s <<< %s|Data=(%d)%s"
                            , GetName()
                            , PROC_NAME
                            , nSentSize
                            , szPacket);
...
/****************************************************************************
 ...
 DATE        : 2014.06.26
****************************************************************************/
bool CCBSession::HandleRegister(QueueItem stQItem)
{
    pktXCCPHeader*  pHeader;
    int             nSentSize = 0;
    char            szTemp[10];
...
/****************************************************************************
 ...
 DATE        : 2014.06.26
****************************************************************************/
bool CCBSession::HandleReqData(QueueItem stQItem)
{
    // set body packet
    ...
    //LOG_WRITE(ILOG_INFO, "QueueOfRequest Push Success. Data=%s", stQItem.szRequestPacket);
