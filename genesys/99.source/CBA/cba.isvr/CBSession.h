...
class CCBSession : public CTcpSessionBase
{
    ...
    // implementation
    public:
        bool HandlePacket(QUEUE_ITEM stQItem);
        bool HandleHeartBeat(QUEUE_ITEM stQItem);
        bool HandleRegister(QUEUE_ITEM stQItem);
        bool HandleReqData(QUEUE_ITEM stQItem);
